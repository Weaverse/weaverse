...
- Updated dependencies
- Updated dependencies
  - @weaverse/schema@0.7.4
  - @weaverse/react@5.8.8
...
- update: add support for page revision preview
  - @weaverse/react@5.8.5
...
- update support for multi-project architecture
