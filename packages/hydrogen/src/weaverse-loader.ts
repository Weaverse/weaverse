...
export async function weaverseLoader({
  ...
  /**
   * @todo read the url and params from the request
   ...
   * @todo the returned data format will be {weaverseData: {}, 3rdPartyData: {}, products: [], collections: [], product: {}, collection: {}, etc}
   */
  return {
    foo: 'bar',
  }
